  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.common.health.HealthReport.ComponentsEntry',
      '10': 'components'
    },
...
final $typed_data.Uint8List liveStatusDescriptor =
    $convert.base64Decode('CgpMaXZlU3RhdHVzEhIKBGxpdmUYASABKAhSBGxpdmU=');
...
final $typed_data.Uint8List readyStatusDescriptor =
    $convert.base64Decode('CgtSZWFkeVN0YXR1cxIUCgVyZWFkeRgBIAEoCFIFcmVhZHk=');
