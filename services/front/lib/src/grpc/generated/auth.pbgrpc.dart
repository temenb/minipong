...
class AuthClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$2.AuthObject> register(
  ...
  $grpc.ResponseFuture<$2.AuthObject> login(
  ...
  $grpc.ResponseFuture<$2.LogoutResponse> logout(
  ...
  $grpc.ResponseFuture<$2.AuthObject> refreshTokens(
    $2.RefreshTokensRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$2.AuthObject> resetPassword(
  ...
  static final _$register =
      $grpc.ClientMethod<$2.RegisterRequest, $2.AuthObject>(
          '/auth.Auth/Register',
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.RefreshTokensRequest, $2.AuthObject>(
        ...
        ($core.List<$core.int> value) =>
            $2.RefreshTokensRequest.fromBuffer(value),
        ($2.AuthObject value) => value.writeToBuffer()));
  ...
  $async.Future<$2.AuthObject> register_Pre($grpc.ServiceCall $call,
      $async.Future<$2.RegisterRequest> $request) async {
    return register($call, await $request);
  }

  $async.Future<$2.AuthObject> register(
      $grpc.ServiceCall call, $2.RegisterRequest request);

  $async.Future<$2.AuthObject> login_Pre(
      $grpc.ServiceCall $call, $async.Future<$2.LoginRequest> $request) async {
    return login($call, await $request);
  }

  $async.Future<$2.AuthObject> login(
  ...
  $async.Future<$2.AuthObject> refreshTokens_Pre($grpc.ServiceCall $call,
      $async.Future<$2.RefreshTokensRequest> $request) async {
    return refreshTokens($call, await $request);
  }

  $async.Future<$2.AuthObject> refreshTokens(
      $grpc.ServiceCall call, $2.RefreshTokensRequest request);
  ...
  $async.Future<$2.AuthObject> resetPassword_Pre($grpc.ServiceCall $call,
      $async.Future<$2.ResetPasswordRequest> $request) async {
    return resetPassword($call, await $request);
  }

  $async.Future<$2.AuthObject> resetPassword(
