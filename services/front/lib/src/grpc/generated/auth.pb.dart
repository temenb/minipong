...
class AuthObject extends $pb.GeneratedMessage {
  ...
  factory AuthObject.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AuthObject.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AuthObject',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AuthObject clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AuthObject copyWith(void Function(AuthObject) updates) =>
      super.copyWith((message) => updates(message as AuthObject)) as AuthObject;
  ...
  @$core.pragma('dart2js:noInline')
  static AuthObject getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AuthObject>(create);
...
class AnonymousSignInRequest extends $pb.GeneratedMessage {
  ...
  AnonymousSignInRequest._();

  factory AnonymousSignInRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AnonymousSignInRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AnonymousSignInRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AnonymousSignInRequest clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AnonymousSignInRequest copyWith(
          void Function(AnonymousSignInRequest) updates) =>
      super.copyWith((message) => updates(message as AnonymousSignInRequest))
          as AnonymousSignInRequest;
  ...
  @$core.pragma('dart2js:noInline')
  static AnonymousSignInRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AnonymousSignInRequest>(create);
