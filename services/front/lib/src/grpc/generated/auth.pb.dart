...
class RefreshTokensRequest extends $pb.GeneratedMessage {
  ...
  RefreshTokensRequest._() : super();
  factory RefreshTokensRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RefreshTokensRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RefreshTokensRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RefreshTokensRequest clone() => RefreshTokensRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RefreshTokensRequest copyWith(void Function(RefreshTokensRequest) updates) => super.copyWith((message) => updates(message as RefreshTokensRequest)) as RefreshTokensRequest;
  ...
  static $pb.PbList<RefreshTokensRequest> createRepeated() => $pb.PbList<RefreshTokensRequest>();
  @$core.pragma('dart2js:noInline')
  static RefreshTokensRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RefreshTokensRequest>(create);
...
class AnonymousSignInRequest extends $pb.GeneratedMessage {
  factory AnonymousSignInRequest({
  ...
  AnonymousSignInRequest._() : super();
  factory AnonymousSignInRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AnonymousSignInRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnonymousSignInRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'auth'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AnonymousSignInRequest clone() => AnonymousSignInRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnonymousSignInRequest copyWith(void Function(AnonymousSignInRequest) updates) => super.copyWith((message) => updates(message as AnonymousSignInRequest)) as AnonymousSignInRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AnonymousSignInRequest create() => AnonymousSignInRequest._();
  AnonymousSignInRequest createEmptyInstance() => create();
  static $pb.PbList<AnonymousSignInRequest> createRepeated() => $pb.PbList<AnonymousSignInRequest>();
  @$core.pragma('dart2js:noInline')
  static AnonymousSignInRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AnonymousSignInRequest>(create);
  static AnonymousSignInRequest? _defaultInstance;
