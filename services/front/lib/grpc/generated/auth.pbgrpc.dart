...
class AuthClient extends $grpc.Client {
  ...
  static final _$register = $grpc.ClientMethod<$2.RegisterRequest, $2.AuthResponse>(
      '/auth.Auth/Register',
  ...
  static final _$refreshTokens = $grpc.ClientMethod<$2.RefreshTokensRequest, $2.AuthResponse>(
  ...
  static final _$resetPassword = $grpc.ClientMethod<$2.ResetPasswordRequest, $2.AuthResponse>(
  ...
  $grpc.ResponseFuture<$2.AuthResponse> register($2.RegisterRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$register, request, options: options);
  }

  $grpc.ResponseFuture<$2.AuthResponse> login($2.LoginRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$2.AuthResponse> refreshTokens($2.RefreshTokensRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$2.AuthResponse> resetPassword($2.ResetPasswordRequest request, {$grpc.CallOptions? options}) {
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.RefreshTokensRequest, $2.AuthResponse>(
        'RefreshTokens',
        refreshTokens_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$2.ForgotPasswordRequest, $0.Empty>(
        ...
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ResetPasswordRequest, $2.AuthResponse>(
        'ResetPassword',
        resetPassword_Pre,
        false,
        false,
  ...
  $async.Future<$2.AuthResponse> register_Pre($grpc.ServiceCall call, $async.Future<$2.RegisterRequest> request) async {
    return register(call, await request);
  }

  $async.Future<$2.AuthResponse> login_Pre($grpc.ServiceCall call, $async.Future<$2.LoginRequest> request) async {
  ...
  $async.Future<$2.AuthResponse> refreshTokens_Pre($grpc.ServiceCall call, $async.Future<$2.RefreshTokensRequest> request) async {
  ...
  $async.Future<$2.AuthResponse> resetPassword_Pre($grpc.ServiceCall call, $async.Future<$2.ResetPasswordRequest> request) async {
  ...
  $async.Future<$2.AuthResponse> register($grpc.ServiceCall call, $2.RegisterRequest request);
  $async.Future<$2.AuthResponse> login($grpc.ServiceCall call, $2.LoginRequest request);
  $async.Future<$2.LogoutResponse> logout($grpc.ServiceCall call, $2.LogoutRequest request);
  $async.Future<$2.AuthResponse> refreshTokens($grpc.ServiceCall call, $2.RefreshTokensRequest request);
  $async.Future<$0.Empty> forgotPassword($grpc.ServiceCall call, $2.ForgotPasswordRequest request);
  $async.Future<$2.AuthResponse> resetPassword($grpc.ServiceCall call, $2.ResetPasswordRequest request);
